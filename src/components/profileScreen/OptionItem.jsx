...
const OptionItem = ({name, color, icon, onPressOption}) => {
  ...
  if(color === 'blue'){
    touchablestyle = "border border-blue-700 rounded-md p-5 my-1 flex-row items-center";
    textStyle = "text-blue-400 text-base font-bold ml-3";
  }

  if(color === 'green'){
    touchablestyle = "border border-green-700 rounded-md p-5 my-1 flex-row items-center";
    textStyle = "text-green-400 text-base font-bold ml-3";
  }

  if(color === 'yellow'){
    touchablestyle = "border border-yellow-700 rounded-md p-5 my-1 flex-row items-center";
    textStyle = "text-yellow-400 text-base font-bold ml-3";
  }

  if(color === 'red'){
    touchablestyle = "border border-red-700 rounded-md p-5 my-1 flex-row items-center";
